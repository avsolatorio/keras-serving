...
json_file = open("result/job_desc_model.json", "r")
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)

# load weights into model
loaded_model.load_weights("result/job_desc_model.h5")
...
# test
classes = loaded_model.predict(np.random.random(size=[1, 500]), batch_size=1)
print("Test:", classes)
